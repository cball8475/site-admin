  ...
  return(
    <div style={{height:"100vh",display:"flex",flexDirection:"column",background:C.dark,fontFamily:"'IBM Plex Sans',sans-serif",overflow:"hidden"}}>
      ...
      <div style={{height:46,background:C.panel,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:"0.65rem",padding:"0 1rem",flexShrink:0}}>
        ...
        <span style={{fontWeight:500,fontSize:10,color:"rgba(255,255,255,0.38)",letterSpacing:"0.08em",borderLeft:`1px solid ${C.border}`,paddingLeft:"0.6rem"}}>DASHBOARD <span title="build stamp" style={{color:"#22c55e",fontWeight:700}}>v0802a</span></span>
      ...
      <div style={{display:mainTab==="snapshot"?"flex":"none",flex:1,overflow:"auto",padding:"1.25rem"}}>
