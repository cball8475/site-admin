...
// Prospects are sourced live from the CRM API (D1). The provider list was
// restarted 2026-06-20 down to William/All-Wayz + Robert/Kaylor; repopulate
// the rest via the "Search Google Places" button on the dashboard.
